...
void model_1_hls4ml_prj(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<Dense_weight_t, 20000>(w4, "w4.txt");
        nnet::load_weights_from_txt<Dense_bias_t, 100>(b4, "b4.txt");
        nnet::load_weights_from_txt<Dense_weight_t, 5000>(w6, "w6.txt");
        nnet::load_weights_from_txt<Dense_bias_t, 50>(b6, "b6.txt");
        nnet::load_weights_from_txt<Dense_weight_t, 50>(w8, "w8.txt");
        nnet::load_weights_from_txt<Dense_bias_t, 1>(b8, "b8.txt");
        loaded_weights = true;
    }
#endif
