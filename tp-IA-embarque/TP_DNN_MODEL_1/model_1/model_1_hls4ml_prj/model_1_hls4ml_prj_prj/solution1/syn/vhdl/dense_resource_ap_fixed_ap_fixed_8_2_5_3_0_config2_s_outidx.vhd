...
entity dense_resource_ap_fixed_ap_fixed_8_2_5_3_0_config2_s_outidx_rom is 
    generic(
             DWIDTH     : integer := 6; 
             AWIDTH     : integer := 7; 
...
architecture rtl of dense_resource_ap_fixed_ap_fixed_8_2_5_3_0_config2_s_outidx_rom is 
...
entity dense_resource_ap_fixed_ap_fixed_8_2_5_3_0_config2_s_outidx is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of dense_resource_ap_fixed_ap_fixed_8_2_5_3_0_config2_s_outidx is
    component dense_resource_ap_fixed_ap_fixed_8_2_5_3_0_config2_s_outidx_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    dense_resource_ap_fixed_ap_fixed_8_2_5_3_0_config2_s_outidx_rom_U :  component dense_resource_ap_fixed_ap_fixed_8_2_5_3_0_config2_s_outidx_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
