...
void model_1_hls4ml_prj::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, (dense_resource_ap_fixed_ap_fixed_8_2_5_3_0_config2_U0_ap_done.read() & 
             dense_resource_ap_fixed_ap_fixed_8_2_5_3_0_config2_U0_ap_continue.read()))) {
            ap_sync_reg_channel_write_layer2_out_0_V = ap_const_logic_0;
        } else {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, (dense_resource_ap_fixed_ap_fixed_8_2_5_3_0_config4_U0_ap_done.read() & 
             dense_resource_ap_fixed_ap_fixed_8_2_5_3_0_config4_U0_ap_continue.read()))) {
            ap_sync_reg_channel_write_layer4_out_0_V = ap_const_logic_0;
        } else {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, (dense_resource_ap_fixed_ap_fixed_8_2_5_3_0_config6_U0_ap_done.read() & 
             dense_resource_ap_fixed_ap_fixed_8_2_5_3_0_config6_U0_ap_continue.read()))) {
            ap_sync_reg_channel_write_layer6_out_0_V = ap_const_logic_0;
        } else {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, (relu_ap_fixed_ap_fixed_16_8_5_3_0_relu_config7_U0_ap_done.read() & 
             relu_ap_fixed_ap_fixed_16_8_5_3_0_relu_config7_U0_ap_continue.read()))) {
            ap_sync_reg_channel_write_layer7_out_0_V = ap_const_logic_0;
        } else {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ap_sync_reg_model_1_hls4ml_prj_entry3_U0_ap_ready = ap_const_logic_0;
    } else {
        if (esl_seteq<1,1,1>(ap_const_logic_1, (ap_start.read() & 
             ap_sync_ready.read()))) {
            ap_sync_reg_model_1_hls4ml_prj_entry3_U0_ap_ready = ap_const_logic_0;
        } else {
            ap_sync_reg_model_1_hls4ml_prj_entry3_U0_ap_ready = ap_sync_model_1_hls4ml_prj_entry3_U0_ap_ready.read();
        }
    }
    if ((esl_seteq<1,1,1>(model_1_hls4ml_prj_entry3_U0_ap_ready.read(), ap_const_logic_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_sync_ready.read()))) {
        model_1_hls4ml_prj_entry3_U0_ap_ready_count = (!model_1_hls4ml_prj_entry3_U0_ap_ready_count.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<2>(): (sc_biguint<2>(model_1_hls4ml_prj_entry3_U0_ap_ready_count.read()) - sc_biguint<2>(ap_const_lv2_1));
    } else if ((esl_seteq<1,1,1>(model_1_hls4ml_prj_entry3_U0_ap_ready.read(), ap_const_logic_1) && 
