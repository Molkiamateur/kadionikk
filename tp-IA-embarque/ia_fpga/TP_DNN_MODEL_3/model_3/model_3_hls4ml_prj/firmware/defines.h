...
typedef struct exponent_type14 { ap_uint<1> sign; ap_int<7> weight; } exponent_type14;
...
typedef struct exponent_type15 { ap_uint<1> sign; ap_int<6> weight; } exponent_type15;
...
typedef struct exponent_type16 { ap_uint<1> sign; ap_int<6> weight; } exponent_type16;
...
typedef struct exponent_type17 { ap_uint<1> sign; ap_int<5> weight; } exponent_type17;
