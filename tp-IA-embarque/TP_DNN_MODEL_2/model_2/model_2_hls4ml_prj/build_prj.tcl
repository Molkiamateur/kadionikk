...
if {$opt(reset)} {
  open_project -reset model_2_hls4ml_prj_prj
} else {
  open_project model_2_hls4ml_prj_prj
}
set_top model_2_hls4ml_prj
add_files firmware/model_2_hls4ml_prj.cpp -cflags "-std=c++0x"
add_files -tb model_2_hls4ml_prj_test.cpp -cflags "-std=c++0x"
...
if {$opt(cosim)} {
  ...
  add_files -tb model_2_hls4ml_prj_test.cpp -cflags "-std=c++0x -DRTL_SIM"
  set time_start [clock clicks -milliseconds]
  cosim_design -trace_level all
  set time_end [clock clicks -milliseconds]
  puts "INFO:"
  puts [read [open model_2_hls4ml_prj_prj/solution1/sim/report/model_2_hls4ml_prj_cosim.rpt r]]
...
if {$opt(vsynth)} {
  ...
  if {[file exist model_2_hls4ml_prj_prj/solution1/syn/vhdl]} {
    set time_start [clock clicks -milliseconds]
