...
keras_model.save('model_3/best_model_3.h5')   
...
hls_model = hls4ml.converters.convert_from_keras_model(model_stripped,
                                                       hls_config=config,
                                                       output_dir='model_3/model_3_hls4ml_prj',
...
config['LayerType']['QDense']['Precision']['weight'] = 'ap_fixed<8,2>'
config['LayerType']['QDense']['Precision']['bias']   = 'ap_fixed<8,2>'
config['LayerType']['QDense']['Precision']['result'] = 'ap_fixed<16,8>'
config['LayerType']['QDense']['ReuseFactor'] = 100
config['LayerType']['QActivation']['ReuseFactor'] = 100   # 100 operation pour 1 dsp
config['LayerType']['QActivation']['Precision'] = 'ap_fixed<16,8>'
