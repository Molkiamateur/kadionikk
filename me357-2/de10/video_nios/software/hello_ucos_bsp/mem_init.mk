...
# Memory: VGA_Char_Buf_Subsystem_Onchip_SRAM
MEM_0 := nios2_VGA_Char_Buf_Subsystem_Onchip_SRAM
$(MEM_0)_NAME := VGA_Char_Buf_Subsystem_Onchip_SRAM
...
$(MEM_0)_HIERARCHICAL_PATH := VGA.Char_Buf_Subsystem.Onchip_SRAM
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: VGA_Char_Buf_Subsystem_Onchip_SRAM
VGA_Char_Buf_Subsystem_Onchip_SRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: onchip_sram
MEM_1 := nios2_onchip_sram
